import { execute, USER_ID } from './composio.js';

const PROPERTY = () => process.env.GA4_PROPERTY || 'properties/349018417';
...
async function report(from, to, extraDims, metric, filter) {
  const r = await execute('GOOGLE_ANALYTICS_RUN_REPORT', USER_ID, {
    property: PROPERTY(),
